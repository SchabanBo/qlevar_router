      ...
      children: [
        Expanded(
          ...
          /*   QButton(
            "child",
            () => QR.toName(
              AppRoutes.nestedChild,
              pageAlreadyExistAction: PageAlreadyExistAction.ToTopRemoveSameKey,
            ),
          ),
          QButton(
            "child 1",
            () => QR.toName(
              AppRoutes.nestedChild1,
              pageAlreadyExistAction: PageAlreadyExistAction.ToTopRemoveSameKey,
            ),
          ),
          QButton(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                TextButton(
                    onPressed: () {
                      router.navigator.show(
                        QDialog(
                          widget: (onPop) => AlertDialog(
                            title: Text('Hi'),
                          ),
                        ),
                      );
